...
<section class="content">
	<div class="container-fluid">
		<div class="block-header">
			<h2>LAPORAN PENJUALAN DAN STATUS OBAT</h2>
		</div>
		<!-- Exportable Table -->
								...
								<tbody>
									...
									foreach ($laporan as $lapor) : ?>
										<tr>
											...
											<td><?= ($lapor['status transaksi'] == 1) ? '<span style="color:red;">Keluar</span>' : '<span style="color:green;">Masuk</span>';  ?></td>
										...
										<?php if ($lapor['status transaksi'] == 2) {
